...
from agents.pdf_engine import render_tailored_pdf
...
def publish_to_s3(
    ...
    # 1. Resume PDF — Render directly from assets and profile using the dynamic engine.
    try:
        resume_bytes = render_tailored_pdf(assets, profile)
